...
void quanly::sort()
{
    ...
    for (int i = 0; i < stt - 1; i++)
    {
        ...
        {
            if (events[j].year < events[minIndex].year || (events[j].year == events[minIndex].year && events[j].month < events[minIndex].month) || (events[j].year == events[minIndex].year && events[j].month == events[minIndex].month && events[j].day < events[minIndex].day) ||
...
void quanly::sortPriority()
{
    for (int i = 0; i < stt - 1; i++)
    {
        ...
        if (minIndex != i)
        {
            ...
            int temp;
            temp = events[i].year;
            events[i].year = events[minIndex].year;
            events[minIndex].year = temp;
            temp = events[i].month;
            events[i].month = events[minIndex].month;
            events[minIndex].month = temp;
            temp = events[i].day;
            events[i].day = events[minIndex].day;
            events[minIndex].day = temp;
            temp = events[i].hour;
            events[i].hour = events[minIndex].hour;
            events[minIndex].hour = temp;
            temp = events[i].minute;
            events[i].minute = events[minIndex].minute;
            events[minIndex].minute = temp;
            temp = events[i].duration;
            events[i].duration = events[minIndex].duration;
            events[minIndex].duration = temp;

            temp = events[i].statistic;
            events[i].statistic = events[minIndex].statistic;
            events[minIndex].statistic = temp;
            string tempStr;
            tempStr = events[i].description;
            events[i].description = events[minIndex].description;
            events[minIndex].description = tempStr;
            tempStr = events[i].address;
            events[i].address = events[minIndex].address;
            events[minIndex].address = tempStr;
            tempStr = events[i].person_to_meet;
            events[i].person_to_meet = events[minIndex].person_to_meet;
            events[minIndex].person_to_meet = tempStr;
            tempStr = events[i].email;
            events[i].email = events[minIndex].email;
            events[minIndex].email = tempStr;
            tempStr = events[i].priority;
            events[i].priority = events[minIndex].priority;
            events[minIndex].priority = tempStr;
            tempStr = events[i].category;
            events[i].category = events[minIndex].category;
            events[minIndex].category = tempStr;
            tempStr = events[i].status;
            events[i].status = events[minIndex].status;
            events[minIndex].status = tempStr;
        }
...
void quanly::exportQueueCSV()
{
    ...
    for (int i = front; i <= rear; i++)
    {
        ...
        string timeStr;
        if (events[index].hour < 10)
            timeStr += "0";
        timeStr += to_string(events[index].hour);
        timeStr += " : ";
        if (events[index].minute < 10)
            timeStr += "0";
...
void quanly::edit()
{
    ...
    case 4:
        ...
        if (events[index].hour < 0 || events[index].hour >= 24)
        {
    ...
    case 5:
        ...
        getline(cin, events[index].description);
        break;
    case 6:
        cout << "Sua phut: ";
        cin >> events[index].minute;
        if (events[stt].minute < 0 || events[stt].minute >= 60)
        {
    ...
    case 8:
        ...
        getline(cin, events[index].person_to_meet);
        break;
    case 9:
        cout << "Sua email: ";
        getline(cin, events[index].email);
        break;
    case 10:
        cout << "Sua status: ";
        cin >> status[index];
